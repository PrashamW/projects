                    ...
                    <div key={key} style={{ width: "55vw", marginLeft: "auto", marginRight: "auto", marginBottom: "2vw", border: "0.2vw solid black", borderRadius: "0.4vw" }} className="box">
                        <Grid container>
                            ...
                            <Grid item xs={9} style={{ fontSize: "1.2vw", paddingTop: "2vw" }}>
                                <div style={{ textAlign: "left", paddingLeft: "0.5vw", color: "black" }}><Link to={`/home/showPost/${el.id}`} style={{textDecoration:"none",color:"black"}}>{el.title ? el.title : "No Title"}</Link></div><br />
                                <Grid container>
                                    <Grid item xs={8}>
